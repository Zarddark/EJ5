...
fun Ej5(){
    ...
    Column (modifier = Modifier
        ...
        Card {
            Column {
                Image(
                    painterResource(id = R.drawable.cuadro),
        ...
        if (state) {
            AlertDialog(
                ...
                title = {
                    Text(text = "Título del AlertDialog")
                },
                text = {
                    Text(text = "Este es un mensaje de ejemplo en el AlertDialog.")
                },
                confirmButton = {
